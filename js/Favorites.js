...
// como os dados seraão estruturados
...
export class FavoritesView extends Favorites {
  ...
  update() {
   this.removeALLtr()
    ...
    this.entries.forEach( user => {
      ...
      const isOk = confirm('tem certeza que você deseja deletar essa linha?')
  ...
  createRow() {
    ...
    tr.innerHTML =  `      
        <td class="user">
          <img src="https://github.com/maykbrito.png" alt="img mayk brito">
